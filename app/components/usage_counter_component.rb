...
class UsageCounterComponent < ViewComponent::Base
    ...
    def initialize(dates)
        ...
        @horses_sorted = horse_num_days(Horse.all)
        @cadets_sorted = cadet_num_days(User.all)
    end
    ...
    def horse_num_days(horses)
        ...
        horse_attendances.sort_by { |horse_attendance| horse_attendance[:num_attendances] }.reverse
    end
    ...
    def cadet_num_days(cadets)
        ...
        # sort in decending order based on attendance count
        cadet_attendances.sort_by { |cadet_attendance| cadet_attendance[:num_attendances] }.reverse
    end
