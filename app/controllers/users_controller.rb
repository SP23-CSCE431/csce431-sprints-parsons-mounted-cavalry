class UsersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user.save
        format.html { redirect_to admins_users_url, notice: "User was successfully created." }
  ...
  def update
    respond_to do |format|
      if @user.update(user_params)
        format.html { redirect_to admins_users_url, notice: "User was successfully updated." }
