User.create!(
    [
        ...
        },
        {
            ...
            skill_level: "Advanced",
            phone_number: "5127400020",
            email: "martin.wnorowski@tamu.edu"
        }
    ]
)
Schedule.create!([{ user_id: 7, recurrence: "TR" }, { user_id: 4, recurrence: "MWF" }, { user_id: 6, recurrence: "TR" }])
Horse.create!(
    [
