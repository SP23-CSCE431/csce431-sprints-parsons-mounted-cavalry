...
RSpec.describe Attendance, type: :model do
  ...
  let(:user) { User.create(is_admin: true, is_staff: true, first_name: 'John', last_name: 'Doe', classification: 'Senior', skill_level: 'Advanced', phone_number: '123-456-7890', email: 'j.doe@tamu.edu') }
  ...
  describe 'update' do
    describe 'schedule change' do
      it 'valid schedule change' do
        new_user = User.create(is_admin: true, is_staff: true, first_name: 'John', last_name: 'Doe', classification: 'Senior', skill_level: 'Advanced', phone_number: '123-456-7890', email: 'j.doe@tamu.edu')
